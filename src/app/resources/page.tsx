        ...
        >
          ...
          <div className="mx-auto w-full max-w-7xl px-5 py-16 sm:px-8 sm:py-20 lg:px-12 lg:py-24">
            ...
            <p className="mt-6 max-w-2xl text-pretty text-lg leading-8 text-brand-muted">
              Preview how reviewed facility information, practical guides, and
              educational resources can be organized in one accessible place.
            </p>

            <div className="mt-8 flex max-w-3xl items-start gap-3 rounded-2xl border border-brand-gold/25 bg-brand-gold/[0.07] px-5 py-4 text-sm leading-6 text-brand-muted">
              <FlaskConical
              ...
              <p>
                ...
                These entries demonstrate the website experience. They are not
                approved Hillside guidance and must be replaced before public
                launch.
              </p>
            </div>
          </div>
